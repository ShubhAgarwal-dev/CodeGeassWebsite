      ...
      <div className={classes.footer}>
        <div className={classes.footerDiv}>
          ...
          <div className={classes.footerLinksWrapper}>
            ...
            <div onClick={() => handleOnClick('/events')} className={`${classes.footerlink} ${classes.navLink}`}>
              Events
            </div>
          </div>
          ...
          <div className={classes.footerContactWrapper}>
            <div>
              <a href="mailto:coding.club@iitdh.ac.in" className={classes.footerlink}>
          ...
          <div className={classes.rightFooterWrapper}>
            <div className={classes.footerIconsWrapper}>
              <Link href="https://www.github.com/oss2019/" target="_blank" className={classes.footerlink}>
                <img
              ...
              <Link href="https://www.github.com/shubhagarwal-dev/" target="_blank" className={classes.footerlink}>
                <img
                  src="https://img.icons8.com/3d-fluency/48/github.png"
                  alt="github"
                  loading="lazy"
